...
<body onload="pageStart();">
  ...
  <a class="button" href="schedule4.php" style="background-color: green;width:15%;height:20px">Appliance 4</a>
  <br><br>
  ...
  <table style="width:80%;">
    ...
    $handle = file_get_contents("scheduledata4.txt");
    $array = [];
    if(!$handle){
