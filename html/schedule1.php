...
<body onload="pageStart();">
  ...
  <a class="button" href="schedule1.php" style="background-color: green;width:15%;height:20px">Appliance 1</a>
  ...
  <table style="width:80%;">
    ...
    $handle = file_get_contents("scheduledata1.txt");
    $array = [];
    if(!$handle){
