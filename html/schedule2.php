...
<body onload="pageStart();">
  ...
  <a class="button" href="schedule2.php" style="background-color: green;width:15%;height:20px">Appliance 2</a>
  <a class="button" href="schedule3.php" style="width:15%;height:20px">Appliance 3</a>
  ...
  <table style="width:80%;">
    ...
    $handle = file_get_contents("scheduledata2.txt");
    $array = [];
    if(!$handle){
